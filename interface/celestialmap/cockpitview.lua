...
function View:renderInfoBox(dt)
  ...
  if info then
    ...
    self.canvas:drawLine(line[1], {mid, line[1][2]}, {178, 178, 178}, 2)
    self.canvas:drawLine({mid, line[1][2]}, {mid, line[2][2]}, {178, 178, 178}, 2)
    self.canvas:drawLine({mid, line[2][2]}, line[2], {178, 178, 178}, 2)
